<script lang="ts">
  ...
  import { staggerReveal } from '../../lib/animate';
  ...
  function handleInView(inView: boolean) {
    if (inView && !hasRevealed && bentoGrid) {
      hasRevealed = true;
      const panels = bentoGrid.querySelectorAll('.bento-cell');
      staggerReveal(panels, [3, 3], 'center');
    }
  }
</script>
...
<section id="features" class="container features-section">
  ...
  <div class="bento-grid" bind:this={bentoGrid} use:useInView={handleInView}>
    ...
    <!-- CONSENSUS (Large) -->
    <div class="bento-cell consensus-cell" style="opacity: 0;">
      <NeonPanel tone="cyan" label="CONSENSUS & HA" code="C-100">
        <div class="cell-content">
          ...
          <!-- Abstract representation of consensus -->
    ...
    <div class="bento-cell scheduling-cell" style="opacity: 0;">
    ...
    <!-- STORAGE (Medium) -->
    <div class="bento-cell storage-cell" style="opacity: 0;">
    ...
    <!-- OPS (Medium) -->
    <div class="bento-cell ops-cell" style="opacity: 0;">
